...
function DialogBox(id, callback) {
    ...
    _onMouseUp = function(evt) {
        ...
        _init = function(id, callback) {
            ...
            _dialog.style.left = ((window.innerWidth - _dialog.clientWidth) -100) + 'px';
            // _dialog.style.top = ((window.innerHeight - _dialog.clientHeight) / 7) + 'px';
            _dialog.style.top = (window.scrollY + 100) + 'px';
